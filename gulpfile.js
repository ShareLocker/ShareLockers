...
gulp.task('serve', shell.task(['python3 sharelockers/manage.py runserver']));
...
gulp.task('deploy', function() {
  return gulp.src('sharelockers/static/**/*').pipe(ghPages());
});
...
gulp.task('scss', function () {
  return gulp.src('./src/css/main.scss')
    ...
    .pipe(gulp.dest('sharelockers/static/css'));
});
...
gulp.task('js', function () {
  ...
  return stream
    ...
    .pipe(gulp.dest('sharelockers/static/js'));
});
...
gulp.task('html', function () {
  return gulp.src([src.allHtml, '!' + src.allViews])
    .pipe(gulp.dest('sharelockers/static'));
});
